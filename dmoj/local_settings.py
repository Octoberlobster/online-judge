...
BRIDGED_JUDGE_ADDRESS = [('localhost', 8098)]

# The bridged daemon bind address and port to communicate with the site.
BRIDGED_DJANGO_ADDRESS = [('localhost', 8099)]
...
EMAIL_USE_TLS = True
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = ''        # 替換成您的Gmail地址
EMAIL_HOST_PASSWORD = ''        # 替換成剛才產生的16位應用程式密碼
EMAIL_PORT = 587
DEFAULT_FROM_EMAIL = 'DMOJ Online Judge <your-email@gmail.com>'  # 替換寄件者資訊
# 正確的設定
SERVER_EMAIL = "errors@dmoj.ca"
DMOJ_SSL = 2
#SITE_BASE_URL = ''
