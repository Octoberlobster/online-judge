...
from judge.views import TitledTemplateView, api, blog, comment, contests, language, license, mailgun, organization, \
    ...
    two_factor, user, widgets, wave, surfer
...
urlpatterns = [
    ...
    path('waves/<str:filename>', wave.WaveformView.as_view(), name='waveform'),
    path('pages_build/<str:filename>', surfer.SurferView.as_view(), name='surfer'),
]
